    ...
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-0 z-50 pointer-events-none mix-blend-difference text-brand-white">
        ...
        <button
          ...
          className="absolute top-[35px] right-[52px] font-display font-bold text-[16px] hover:opacity-70 transition-opacity pointer-events-auto cursor-pointer"
        >
          #about
        </button>
      </div>
      ...
      <div className={`fixed top-0 right-0 h-full w-full md:w-[600px] bg-black z-[60] shadow-2xl transition-transform duration-500 ease-in-out ${isPanelOpen ? 'translate-x-0' : 'translate-x-full'
        ...
        <div className="relative w-full h-full text-white">
          ...
          <button
            ...
            className="absolute top-[39px] right-[54px] font-display font-bold text-[16px] hover:opacity-70 cursor-pointer z-20"
          >
            x
          </button>
